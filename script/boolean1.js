...
if(c > 10){console.log("c는 10보다 크다")}//o
if(d <= 20){console.log("d는 20보다 작거나 같다")}//o
if(b != true){console.log("b는 참이 아니지")}//o
//--------------------------------------------
console.log('====================')
...
login_btn.addEventListener('click',()=>{
    ...
    if(user_id.value == "admin"){
        //input의 값이 빈 문자열이 아닐 때
        // console.log("input의 값이 작성되어있다")
        alert(`관리자님 어서오세요`)
    }else{
...
//사용자가 입력한 숫자가 짝수일경우만 (홀수반응x)
//팝업창으로 "당신이 입력한 ?? 수는 짝수입니다" 출력
console.log('====================')
//5000보 이상일 경우 "목표 달성 완료!!" 출력
...
print_btn.addEventListener('click',()=>{
    ...
    if(result){//참에 대한 코드블록
        window.print()
        //인쇄할까요에서 확인을 클릭해서 true를 반환받았을 때 if문이 실행되는 결과 만들기
    }else{//거짓에 대한 코드블록{}
        alert(`인쇄가 취소되었습니다.`)
    }
})