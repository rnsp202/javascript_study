...
//추가연습 4~6
li[3].classList.add('bg_lp')
li[3].classList.add('text_bi')
li[4].classList.add('text_bi')
li[4].classList.add('bg_bl')
li[5].classList.add('bg_bl')
li[5].classList.add('text_pi')
li[5].className += ' bor_sal'
...
q[0].addEventListener('mouseover',()=>{
    q[0].nextElementSibling.classList.add('on')
})
q[0].addEventListener('mouseout',()=>{
    q[0].nextElementSibling.classList.remove('on')
})
